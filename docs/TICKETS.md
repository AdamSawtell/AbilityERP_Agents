...
| SAW053 | `bugbot_hardening` | app | Gate BFF mutations; ROSTER_BOT_API_KEY alias; fix vacant horizon today/period/next | in-progress | [#12](https://github.com/AdamSawtell/AbilityERP_Agents/issues/12) · `admin-ui/middleware.ts` |
