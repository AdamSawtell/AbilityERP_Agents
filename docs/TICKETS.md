...
| SAW049 | `roster_rules_framework` | app | Configurable roster matching rules (AbilityAPP AB-0046 pattern): DB + API + Rules UI + matcher wiring | in-progress | [#8](https://github.com/AdamSawtell/AbilityERP_Agents/issues/8) · `admin-ui/lib/engine/rosterRules.ts` · migration `007_roster_rules.sql` |
