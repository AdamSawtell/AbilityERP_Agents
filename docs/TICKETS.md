...
| SAW051 | `erp_shift_deeplink` | app | Hyperlink proposals/shift panel to iDempiere Shift (Rostered) via Zoom URL | in-progress | [#10](https://github.com/AdamSawtell/AbilityERP_Agents/issues/10) · `admin-ui/lib/idempiere/zoom.ts` |
