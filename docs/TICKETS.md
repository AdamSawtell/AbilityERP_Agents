...
| SAW045 | `ross_phase4` | app | Ross Phase 4 planner & reports (4a briefing first; no Entra) | in-progress | [#4](https://github.com/AdamSawtell/AbilityERP_Agents/issues/4) · [PHASE-4-CONTRACT](./PHASE-4-CONTRACT.md) |
