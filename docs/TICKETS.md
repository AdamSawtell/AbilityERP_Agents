...
| SAW050 | `proposal_card_ux` | app | Proposal cards: readable when/where/client + human match reasons | in-progress | [#9](https://github.com/AdamSawtell/AbilityERP_Agents/issues/9) · `admin-ui/components/DashboardClient.tsx` |
